...
async function generateCode() {
  ...
  await generateStrapiSchemas(templates);
...
async function generateStrapiSchemas(templates) {
    ...
    "components": {
      "hero_section": {
        ...
        "attributes": {
          ...
          "ctas": { "type": "component", "repeatable": true, "component": "shared.cta_button", "max": 3 },
          "theme": { "type": "component", "component": "shared.section_theme" }
        }
      },
      "split_media": {
        "displayName": "Split Media",
        "attributes": {
          "title": { "type": "string", "required": true },
          "rich_text": { "type": "richtext" },
          "media": { "type": "media", "multiple": false },
          "media_position": { "type": "enumeration", "enum": ["left", "right"], "default": "right" },
          "ctas": { "type": "component", "repeatable": true, "component": "shared.cta_button" },
          "theme": { "type": "component", "component": "shared.section_theme" }
        }
      },
      "feature_band": {
        ...
        "attributes": {
          "title": { "type": "string" },
          "features": { "type": "component", "repeatable": true, "component": "shared.feature_card", "max": 6 },
          "columns": { "type": "enumeration", "enum": ["2", "3", "4"], "default": "3" },
          "theme": { "type": "component", "component": "shared.section_theme" }
        }
      },
      "cta_band": {
        ...
        "attributes": {
          "title": { "type": "string", "required": true },
          "subtitle": { "type": "string" },
          "ctas": { "type": "component", "repeatable": true, "component": "shared.cta_button", "max": 2 },
          "theme": { "type": "component", "component": "shared.section_theme" }
        }
      },
      "faq_section": {
        ...
        "attributes": {
          "title": { "type": "string" },
          "faqs": { "type": "component", "repeatable": true, "component": "shared.faq_item" },
          "theme": { "type": "component", "component": "shared.section_theme" }
        }
      },
      "contact_band": {
        ...
        "attributes": {
          "title": { "type": "string", "required": true },
          "form_fields": { "type": "json" },
          "contact_info": { "type": "component", "repeatable": true, "component": "shared.contact_info" },
          "theme": { "type": "component", "component": "shared.section_theme" }
        }
      }
    },
    "shared": {
      "cta_button": {
        ...
        "attributes": {
          ...
          "style": { "type": "enumeration", "enum": ["primary", "secondary", "outline"], "default": "primary" }
        }
      },
      "section_theme": {
        "displayName": "Section Theme",
        "attributes": {
          "bg": { "type": "enumeration", "enum": ["black", "white", "orange", "gray", "custom"], "default": "white" },
          "invertText": { "type": "boolean", "default": false }
        }
      },
      "feature_card": {
    ...
    "collections": {
        ...
        "attributes": {
          ...
          "sections": {
            ...
            "components": [
              ...
              "sections.split_media",
              "sections.feature_band",
              "sections.cta_band",
              "sections.faq_section",
              "sections.contact_band"
            ]
          }
        }
      },
      "navigation": {
        ...
        "attributes": {
          ...
          "items": { "type": "component", "repeatable": true, "component": "shared.nav_item" }
        }
      },
      "settings": {
  ...
  templates.forEach(tpl => {
    mapping[tpl.id] = {
      components: tpl.sampleBlocks.map(block => {
        if (block.hasHero) return "hero_section";
        if (block.hasForms) return "contact_band";
        if (block.hasFAQ) return "faq_section";
        if (block.hasGallery) return "gallery_grid";
        if (block.ctas.length > 2) return "cta_band";
        return "rich_text_block";
      }),
      themes: tpl.sampleBlocks.map(block => block.color)
    };
  });
  
  await fs.writeFile(path.join(ROOT_DIR, 'strapi', 'schemas', 'components.json'), JSON.stringify(components, null, 2));
  await fs.writeFile(path.join(ROOT_DIR, 'strapi', 'schemas', 'collections.json'), JSON.stringify(collections, null, 2));
  await fs.writeFile(path.join(ROOT_DIR, 'strapi', 'mapping.json'), JSON.stringify(mapping, null, 2));
}
